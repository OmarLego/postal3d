...
class QuakePlayer : PlayerPawn
{
    ...
    override void PlayerThink()
    {
        ...
        if (wasOnGround && !player.onGround && pos.z - GetZAt() < maxDropOffHeight && vel.z <= 0)
        {
            ...
            player.deltaViewHeight -= (pos.z - GetZAt()) / 9;
			// before you could get on and off a stair really fast and it would make the
			//  player taller until you got on another stair, increasing the division
			//   seems to fix it at least to me idk i have glasses my vision isnt the best
            SetZ(GetZAt());
    ...
    override void CalcHeight()
    {
		...
		if (player.playerstate == PST_LIVE)
        {
			...
			//player.viewHeight += player.deltaViewHeight * 900 / stepReturnTics;//makes height change instant, looks worse but you cant exploit it as i have no idea how to fix the normal height change function lma//not needed
